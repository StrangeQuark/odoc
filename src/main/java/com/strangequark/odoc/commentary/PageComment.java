...
class PageComment {
    ...
    PageComment(UUID id, UUID pageId, UUID parentId, String author, String body, Instant createdAt) {
        this.id = id; this.pageId = pageId; this.parentId = parentId; this.author = author; this.body = body; this.createdAt = createdAt;
    }
    UUID getId() { return id; } UUID getPageId() { return pageId; } UUID getParentId() { return parentId; }
    String getAuthor() { return author; } String getBody() { return body; } Instant getCreatedAt() { return createdAt; }
}
